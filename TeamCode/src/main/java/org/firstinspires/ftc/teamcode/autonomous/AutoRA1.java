...
@Autonomous (name = "Red Audience 1")
public class AutoRA1 extends OpMode {

    private Follower follower;
    private Timer pathTimer, opmodeTimer, waitTimer;

    private int pathState;
    private final Pose startPose = new Pose(87.7798165, 8, Math.toRadians(90)); // Start Pose of our robot.
    private final Pose scorePose = new Pose(88.2201834, 14.64220183, Math.toRadians(68));
    private final Pose align1Pose = new Pose(108.1926605, 35.71559633, Math.toRadians(0));
    private final Pose pickup1Pose = new Pose(131.43119266, 35.605545, Math.toRadians(0));
